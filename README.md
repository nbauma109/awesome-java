...
- [ECD++](https://github.com/nbauma109/ecd) - Eclipse plug-in variant of ECD (official ECD++ branding) in the same repository with multi-decompiler support and class-file debugging.
